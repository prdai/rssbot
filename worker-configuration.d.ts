/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35ec06c9d7dfbf3eee4e521a371a2a54)
// Runtime types generated with workerd@1.20251202.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkerContainer";
	}
	interface Env {
		MONGODB_URI: string;
		UNTRACKED_FEED_MAX_ITEMS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MONGODB_URI" | "UNTRACKED_FEED_MAX_ITEMS" | "GOOGLE_API_KEY" | "EMAIL_ADDRESS" | "EMAIL_PASSWORD">> {}
}
